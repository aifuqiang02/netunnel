...
更便宜、更直接的内网穿透。几分钟把本地服务发布到公网。

支持 `HTTP`、`TCP`、域名隧道，适合开发联调、临时演示和远程访问。
...
- 几分钟把本地服务发布到公网
- 支持 `HTTP`、`TCP`、域名隧道
- 用桌面客户端统一管理设备、隧道和访问地址
- 按量计费，适合轻量和临时使用场景

## 下载客户端

- 桌面客户端下载：`待补充正式下载地址`
- 如果后续使用 GitHub Release 作为分发入口，这里可以直接替换为 Release 链接
- 建议同时提供版本号、系统支持范围和更新说明入口
...
- `docs/README.md`
- `src/netunnel-docs-site/` - 官网与文档站子项目
- `AGENTS.md`
