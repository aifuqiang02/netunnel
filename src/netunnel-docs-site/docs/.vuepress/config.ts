...
export default defineUserConfig({
  ...
  locales: {
    '/': {
      title: 'Netunnel',
      lang: 'zh-CN',
      description: '几分钟把本地服务发布到公网。Netunnel 提供 HTTP、TCP、域名隧道，适合开发联调、回调调试、临时演示和远程访问。',
    },
  },
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Netunnel' }],
    ['meta', { property: 'og:description', content: '几分钟把本地服务发布到公网。适合开发联调、回调调试、临时演示和远程访问。' }],
  ],
  ...
  theme: plumeTheme({
    ...
    // hostname: 'https://your-netunnel-site.example.com',
    ...
    //   audioReader: true,  // 启用嵌入音频朗读功能  @[audioReader](url)
      icon: {
        provider: 'iconify',
        preload: ['lucide:rocket', 'lucide:laptop', 'lucide:network'],
      },
